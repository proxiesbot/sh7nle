...
export default function Edit({ paymentMethod }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        binanceMerchantId: paymentMethod.config?.binance?.merchant_id || '',
        binanceApiKey: paymentMethod.config?.binance?.api_key || '',
        binanceSecretKey: paymentMethod.config?.binance?.secret_key || '',
        binanceWebhookSecret: paymentMethod.config?.binance?.webhook_secret || '',
        binanceCurrency: paymentMethod.config?.binance?.currency || 'USDT',
        binanceReturnUrl: paymentMethod.config?.binance?.return_url || '',
        _method: 'PUT',
    });
